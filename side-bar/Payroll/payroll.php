...
$select_all_list = "SELECT * FROM `tbl_payroll_list` WHERE Payroll_Status = 'Pending'";
			...
			<div class="home-content">
				...
				<div class="box-payroll">
					<div class="payroll-nav-bar">
						<ul class="active" >
							<li ><a href="payroll_layout.php" style="color:#66ff66;"   >Payroll</a> <img src="../../icons/checklist.png" id="img_salary" > </li>
							<li ><a href="record_layout.php" >Record</a> <img src="../../icons/ready.png" id="img_salary" > </li>
							...
							<table class="payroll-table">
								...
								<tbody>
									<tr>
										...
										<td><a href="proceed.php?id=<?php echo $fetch_list['Payroll_ID']; ?>" ><img id="proceed" src="../../icons/check.png" ></a></td>
										<td><a href="delete.php?id=<?php echo $fetch_list['Payroll_ID']; ?>" ><img id="delete" src="../../icons/delete.svg" ></a></td>
									</tr>
								</tbody>
