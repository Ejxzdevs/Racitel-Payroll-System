...
<head>
	...
	<link rel="stylesheet" type="text/css" href="sub-payroll.css">
...
<body>
	<div class="background">
		...
		<div class="div-background">
			...
			<div class="popup-salary">
				<label id="date"><?php echo date('Y-m-t'); ?></label>
				<div class="box-salary">	
				<form action="generate.php" method="POST">
					<div class="pop-salary-header">
						<label>SET DATE</label>
					</div>
					<div class="pop-salary-body">
							<div class="filter-salary-date-left">
								<label>From</label>
								<input type="date" value="<?php date_default_timezone_set('Asia/Manila'); $first_date = date('Y-m-01'); echo $first_date;   ?>" name="fr-date-salary">
							</div>
							<div class="filter-salary-date-right">
								<label>To</label>
								<input type="date" value="<?php date_default_timezone_set('Asia/Manila'); $last_date = date('Y-m-t'); echo $last_date;   ?>" name="to-date-salary"  >
							</div>
					</div>
					<div class="popup-salary-lower">
							<div class="popup-salary-lower-left "><button name="submit-salary">SUBMIT</button></div>
							<div class="popup-salary-lower-right"><a type="hidden" id="cancel" href="payroll.php">CANCEL</a></div>
					</div>
				</form>
				</div>
			</div>
	...
	<!-- <script type="text/javascript">
		document.getElementById("create-payroll").addEventListener("click", function(){
		document.querySelector(".popup-salary").style.display="flex";
		})
		document.getElementById("close-payroll").addEventListener("click",function(){
		document.querySelector(".popup-salary").style.display="none";
		})
	</script> -->
</body>
</html>