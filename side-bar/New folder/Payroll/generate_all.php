...
$select_all_id = "SELECT * FROM (SELECT * FROM tbl_employees_information WHERE Employee_Types = '$emp_type') tbl_employees_information INNER JOIN (SELECT * FROM tbl_time_entries WHERE Date_Attendance BETWEEN '$start' AND '$end') tbl_time_entries on tbl_employees_information.Employees_ID = tbl_time_entries.Employees_ID";
...
<body>
	<div class="generate-container" id="generate-container">
		<div class="pay_header" id="btn-generate">
			<div class="row-btn">
				<a id="btn-print-generate" href="print_payslip.php?payroll_id=<?php echo $payroll_id; ?>">PAID</a>
			</div>
			<div class="row-btn">
				<a id="btn-print-generate" href="download_all_payslip.php?payroll_id=<?php echo $payroll_id; ?>">DOWNLOAD AS PDF</a>
			</div>
