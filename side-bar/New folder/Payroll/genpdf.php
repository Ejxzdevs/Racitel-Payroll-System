...
$query=mysqli_query($conn,"SELECT * FROM tbl_employees_information inner join  tbl_personal_information ON tbl_employees_information.Employees_ID = tbl_personal_information.Employees_ID");
