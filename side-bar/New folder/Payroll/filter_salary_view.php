							...
							<table class="payroll-table">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="salary_view.php?id="<?php echo $entries['Employees_ID']; ?> >view</a></td>
									</tr>
						...
						<div class="salary-lower">
							...
							<div class="salary-lower-right">
								...
								<div class="right-2">
									...
									<!-- <img src="../../icons/create.svg" class="img_create"> -->Create Payroll</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="con_salview">
					...
					<div class="header-info">
						...
						<div class="info-emp">
							...
							<div class="con_img">
								<img src="../employees/<?php echo $res_salary_view1['Employee_Image']; ?>">
							</div>
							<div class="con_info">
								<label><?php echo $res_salary_view1['Employees_ID']; ?></label>
								<label><?php echo $res_salary_view1['First_Name']; ?> <?php echo $res_salary_view1['Last_Name']; ?></label>
								<label><?php echo $res_salary_view1['Job_Department']; ?></label>
								<label><?php echo $res_salary_view1['Position']; ?></label>
						...
						<div class="info-salary">
							<div class="earning">
								...
								<div class="data-earn">
									<div class="a">
										<p>Worked days:  <span><?php echo $res_salary_view1['worked_days']; ?></span> </p>
										<p>Total regular Time:  <span><?php echo $res_salary_view1['r']; ?></span> </p>
										<p>Total overtime:  <span><?php echo $res_salary_view1['ot']; ?></span> </p>
									</div>
									<div class="b">
										<p>Basic pay:  <span><?php echo $res_salary_view1['Basic_Salary']; ?></span> </p>
										<p>Overtime pay:  <span><?php echo $res_salary_view1['OT_Salary']; ?></span> </p>
								...
								<div class="data-deduc">
									<div class="a">
										<p>PHIL-HEALTH:  <span><?php echo $res_salary_view1['PHILHEALTH']; ?></span> </p>
										<p>SSS:  <span><?php echo $res_salary_view1['SSS']; ?></span> </p>
										<p>PAG-IBIG:  <span><?php echo $res_salary_view1['PAGIBIG']; ?></span> </p>
									</div>
									<div class="b">
								...
								<div class="data-net-pay">
									<div class="a">
										<p>Gross pay:  <span><?php echo $res_salary_view1['Sum_Daily_Salary']; ?></span> </p>
										<p>Total deduction:  <span><?php echo $res_salary_view1['Total_Deduction']; ?></span> </p>
										<p>Net pay:  <span><?php echo $res_salary_view1['Sum_Daily_Salary'] - $res_salary_view1['Total_Deduction']; ?></span> </p>
					...
					<?php }WHILE($res_salary_view1=$query_salary1->fetch_assoc()); ?>
				</div>
			</div>
		</div>
