			...
			<div class="home-content">
				<div class="box-attendance">
					<div class="attendance-nav-bar">
						<ul  >
							<li ><a href="schedule_layout.php" style="color:#66ff66;" class="schedule1" >INDOOR</a><img src="../../icons/workplace.png"> </li>
						...
						<div class="sched-table">
								<table class="sched-info">
									...
									<tbody>
										...
										<td><?php if($entries['Time_Out'] == '00:00:00.000000'){
											echo "";
										 }else {
										 	echo  date('g:i a',strtotime($entries['Time_Out']));
										 }?></td>
										<!-- <td>s</td> -->
										<td><?php echo date('g:i a' ,strtotime($entries['Time_End'])); ?> </td>
										<td><a href="javascript: time_info(<?php echo $entries['Employees_ID']; ?>);" ><img id="view" src="../../icons/view-action.svg" ></a>
