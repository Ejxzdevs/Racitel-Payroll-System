				...
				<div class="box-payroll">
					<div class="payroll-nav-bar">
						<ul class="active" >
							...
							<li><a href="deduction.php" style="color:#66ff66;" >Approved</a><img id="img_history" src="../../icons/ready.png">  </li>
							<li><a href="deduction.php" >Pending</a><img id="img_history" src="../../icons/waiting-list.png">  </li>
