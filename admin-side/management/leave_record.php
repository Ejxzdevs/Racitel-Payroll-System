					...
					<div class="salary">
						...
						<div class="salary-body" style="height: 420px;">
							<table class="payroll-table" >
								...
								<tbody>
									<?php do{ if(isset($res_query_record['Employees_ID'])){ ?>
									<tr>
										<td><?php  echo $res_query_record['Employees_ID']; ?></td>
										<td>
										<img width="30" height="30" 
										<?php if($res_query_record['Employee_Image'] ==  TRUE){ ?>
										src="../employees/emp-image/<?php echo $res_query_record['Employee_Image']; ?>"
									<?php }else{ ?>
										src="../employees/emp-image/user1.png"
									<?php } ?>
										>
										</td>
