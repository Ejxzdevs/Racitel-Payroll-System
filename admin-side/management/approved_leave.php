				...
				<div class="box-payroll">
					<div class="payroll-nav-bar">
						<ul class="active" >
							...
							<li ><a href="approved_leave_layout.php" style="color:#66ff66;" >Approved</a> <img src="../../icons/ready.png" id="img_salary" > </li>
					...
					<div class="salary">
						<div class="salary-header">
							...
							<div class="salary-header-right">
								<div class="container">
								<form method="POST" action="approved_leave_layout.php" class="form">
									<div class="containter-search">
										...
										<input type="submit" name="approved_search"  value="Search" class="search">
										</div>
									</div>
								</form>
								</div>
						...
						<div class="salary-body" >
							<table class="payroll-table"  >
								...
								<tbody>
									<?php do{ if(isset($res_file_leave2['Employees_ID'])){ ?>
									<tr>
										<td><?php echo $res_file_leave2['Employees_ID']; ?></td>
										<td><?php echo $res_file_leave2['First_Name']; ?> <?php echo $res_file_leave['Last_Name']; ?></td>
										<td><?php echo $res_file_leave2['Leave_Types']; ?></td>
										<td><?php echo date('M d Y',strtotime($res_file_leave2['Leave_Date'])); ?></td>
										<td><a href="approved_leave_view_layout.php?id=<?php echo $res_file_leave2['Leave_ID']; ?>" ><img src="../../icons/email.svg" id="img_leave_view"></a></td>
										<td><a href="cancel_leave.php?id=<?php echo $res_file_leave2['Leave_ID']; ?>"><img id="reject" src="../../icons/cross.png" ></a></td>
									</tr>
										
								</tbody>
								<?php }}while($res_file_leave2=$file_leave2->fetch_assoc()); ?>
							</table>
						</div>
