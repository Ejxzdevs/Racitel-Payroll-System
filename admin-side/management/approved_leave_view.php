				...
				<div class="leave-container">
					<form>
						<div class="title-message">
							...
							<a href="approved_leave_layout.php"><img id="close-leave-message" src="../../icons/close.svg"></a>
						</div>
						<div class="message-body">
							...
							<div class="head-message">
									<div class="leave-img">
									<img id="leave-img" 
									<?php if($res_query_leave['Employee_Image'] == ''){ ?>	
										src="../../icons/user1.png"
									<?PHP }ELSE{ ?>
										src="../employees/emp-image/<?php echo $res_query_leave['Employee_Image']; ?>"						
								<?php } ?>
									>									
								</div>
