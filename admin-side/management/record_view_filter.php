			...
			<div class="home-content">
				...
				<div class="box-payroll">
					<div class="payroll-nav-bar">
						<ul class="active" >
						<li ><a href="leave_layout.php"    >Daily</a> <img src="../../icons/leave_list.svg" id="img_salary" > </li>
								<li><a href="pending_leave_layout.php">Approved</a><img id="img_history" src="../../icons/documents.svg">  </li>
							<li><a href="pending_leave_layout.php"  >Pending</a><img id="img_history" src="../../icons/documents.svg">  </li>
							<li><a style="color:#66ff66;" href="leave_record_layout.php" >Record</a><img id="img_history" src="../../icons/documents.svg">  </li>
						</ul>
					</div>
					<div class="salary">
					...
					<div class="body-record-leave">
						<div class="img-record-leave">
							<div class="personal-date">
								<form method="POST" action="record_view_filter_layout.php">
									<input type="number" min="2023" max="2099" name="fil-yrs" class="year" value="<?php echo $year;?>">
							...
							<img id="record-img" src="../../side-bar/employees/<?php echo $res_query_leave_record1['Employee_Image']; ?>">
							</div>

							<div class="personal-data">
							<p>Emp-ID: <span><?php echo $id; ?></span></p>
							<p>Name: <span><?php echo $res_query_leave_record1['First_Name']; ?> <?php echo $res_query_leave_record1['Last_Name']; ?></span></p>
							<p>Dept: <span><?php echo $res_query_leave_record1['Job_Department']; ?></p>
							<p>Pos: <span><?php echo $res_query_leave_record1['Position']; ?></span></p>
						...
						<div class="record-leave">
							<table class="rec">
								...
								<?php do{ if(isset($res_query_leave_record1['Employees_ID'])) { ?>
								<tbody>		
									<tr>
								<td>
										<p><?php echo $res_query_leave_record1['Leave_Types']; ?></p>
								</td>
								<td>
									<p><?php echo date('M. d Y',strtotime($res_query_leave_record1['Leave_Date'])); ?>
								...
								<?php }}while($res_query_leave_record1=$query_leave_record1->fetch_assoc()); ?>
							</table>
						</div>
