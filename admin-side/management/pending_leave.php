				...
				<div class="box-payroll">
					<div class="payroll-nav-bar">
						<ul class="active" >
							...
							<li><a href="pending_leave_layout.php"style="color:#66ff66;" >Pending</a><img id="img_history" src="../../icons/waiting-list.png">  </li>
					...
					<div class="salary">
						<div class="salary-header">
							...
							<div class="salary-header-right">
								<div class="container">
								<form method="POST" action="pending_leave_layout.php" class="form">
									<div class="containter-search">
										...
										<input type="submit" name="pending_search"  value="Search" class="search">
										</div>
									</div>
								</form>
								</div>
						...
						<div class="salary-body" >
							<table class="payroll-table"  >
								...
								<tbody>
									<?php do{ if(isset($res_file_leave1['Employees_ID'])){ ?>
									<tr>
										...
										<td><a href="pending_leave_view_layout.php?id=<?php echo $res_file_leave1['Leave_ID']; ?>" ><img src="../../icons/email.svg" id="img_leave_view"></a></td>
										<td><?php echo $res_file_leave1['Leave_Status']; ?></td>
										<td><a href="accepting_leave.php?id=<?php echo $res_file_leave1['Leave_ID']; ?>"><img id="accept" src="../../icons/check.png" ></a>

											<a href="reject_leave.php?id=<?php echo $res_file_leave1['Leave_ID']; ?>"><img id="reject" src="../../icons/cross.png" ></a>
										</td>
