			...
			<div class="home-content">
				...
				<div class="box-attendance">
					<div class="attendance-nav-bar">
						<ul  >
							<li ><a href="department_layout.php" style="color:#66ff66;" class="schedule1" >Department</a><img src="../../icons/schedule1.svg"> </li>
							<li><a href="position_layout.php">Position</a><img src="../../icons/time_record.svg"> </li>
