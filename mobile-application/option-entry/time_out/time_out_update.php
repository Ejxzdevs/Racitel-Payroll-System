...
if (isset($_POST['submit'])) {
	...
	$test = "UPDATE `tbl_time_entries` SET Time_Out = '$time_out', Regular_Time = '$regular_time' , Hours_Worked = '$total_hours' , Overtime = '$overtime' , Daily_Status = '$status', No_Halfday = '$num_halfday', No_Late = '$num_late', No_Undertime = '$num_undertime', No_holiday = '$num_holiday', Undertime = '$undertime',Time_End = '$time_end',Image_Time_Out = '$fileDestination' where Date_Attendance = '$date' AND Employees_ID = '$id' ";
...
// computation salary
	...
	$Earning = "INSERT INTO `tbl_salary_earning` (`Employees_ID`,`Regular_Salary`,`Ot_Salary`,`Daily_Salary`,`Earning_Date`,`Undertime_D`,`Late_D`) VALUES ('$id','$regular_salary','$Ot_salary','$total_salary','$date','$late_deduction','$undertime_deduction')";
